...
CREATE TABLE family_links (
  ...
  family_member_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE sponsor_actions_audit (
  id TEXT PRIMARY KEY,
  sponsor_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  family_member_id TEXT REFERENCES users(id) ON DELETE SET NULL,
  family_link_id TEXT REFERENCES family_links(id) ON DELETE SET NULL,
  sponsor_request_id TEXT REFERENCES sponsor_requests(id) ON DELETE SET NULL,
