          ...
          <div className="space-y-2">
            ...
            >
              ...
              <span className="flex flex-col gap-0.5">
                <span className="text-xs font-semibold text-foreground">{currentBase.name}</span>
                <span className="text-[0.65rem] text-muted-foreground">{currentBase.region}</span>
              </span>
            </button>
            {baseSearch && (
              <div className="rounded-xl border border-border bg-card p-3">
                ...
                {selectedBaseId && selectedBaseId !== currentBase.id && (
                  <Button
                    className="mt-2 h-7 w-full justify-center rounded-lg text-xs font-semibold"
                    type="button"
